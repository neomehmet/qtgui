...
#define get_CRC_VCU_WarnMsg float32( fev_VCU_WarnMsg.CRC_VCU_WarnMsg*1+0 )
#define get_ALV_VCU_WarnMsg float32( fev_VCU_WarnMsg.ALV_VCU_WarnMsg*1+0 )
#define get_VCU_GearPAtStationaryOnly float32( fev_VCU_WarnMsg.VCU_GearPAtStationaryOnly*1+0 )
#define get_VCU_GearPNotPossible float32( fev_VCU_WarnMsg.VCU_GearPNotPossible*1+0 )
#define get_VCU_PressBreakToEngageGear float32( fev_VCU_WarnMsg.VCU_PressBreakToEngageGear*1+0 )
#define get_VCU_CantChangeGear float32( fev_VCU_WarnMsg.VCU_CantChangeGear*1+0 )
#define get_VCU_MotorCoolantPumpErr float32( fev_VCU_WarnMsg.VCU_MotorCoolantPumpErr*1+0 )
#define get_VCU_EmergencyShutdown float32( fev_VCU_WarnMsg.VCU_EmergencyShutdown*1+0 )
#define get_VCU_HeatLoopTempSensorErr float32( fev_VCU_WarnMsg.VCU_HeatLoopTempSensorErr*1+0 )
#define get_VCU_GearMalfunc float32( fev_VCU_WarnMsg.VCU_GearMalfunc*1+0 )
#define get_VCU_CoolingTempExceedLimit float32( fev_VCU_WarnMsg.VCU_CoolingTempExceedLimit*1+0 )
#define get_VCU_TransmissionMalfunction float32( fev_VCU_WarnMsg.VCU_TransmissionMalfunction*1+0 )
#define get_VCU_ParkLockNotEngaged float32( fev_VCU_WarnMsg.VCU_ParkLockNotEngaged*1+0 )
#define get_VCU_CoolantTempHigh float32( fev_VCU_WarnMsg.VCU_CoolantTempHigh*1+0 )
#define get_VCU_CheckDriveTrain float32( fev_VCU_WarnMsg.VCU_CheckDriveTrain*1+0 )
#define get_VCU_OBCTempHigh float32( fev_VCU_WarnMsg.VCU_OBCTempHigh*1+0 )
#define get_VCU_DCDC_TempHigh float32( fev_VCU_WarnMsg.VCU_DCDC_TempHigh*1+0 )
#define get_VCU_ChargingInletTempHigh float32( fev_VCU_WarnMsg.VCU_ChargingInletTempHigh*1+0 )
#define get_VCU_HVILErr float32( fev_VCU_WarnMsg.VCU_HVILErr*1+0 )
#define get_VCU_Limphome float32( fev_VCU_WarnMsg.VCU_Limphome*1+0 )
#define get_VCU_HVSystemReduced float32( fev_VCU_WarnMsg.VCU_HVSystemReduced*1+0 )
#define get_CRC_VCU_StatusDCDC float32( fev_VCU_StatusDCDC.CRC_VCU_StatusDCDC*1+0 )
#define get_ALV_VCU_StatusDCDC float32( fev_VCU_StatusDCDC.ALV_VCU_StatusDCDC*1+0 )
#define get_DCDC_status float32( fev_VCU_StatusDCDC.DCDC_status*1+0 )
#define get_DCDC_maxCurrentOut float32( fev_VCU_StatusDCDC.DCDC_maxCurrentOut*0.1+0 )
#define get_DCDC_iOutput float32( fev_VCU_StatusDCDC.DCDC_iOutput*0.1+0 )
#define get_DCDC_vDCInput float32( fev_VCU_StatusDCDC.DCDC_vDCInput*0.0625+0 )
#define get_DCDC_vOutput float32( fev_VCU_StatusDCDC.DCDC_vOutput*0.0625+0 )
#define get_CRC_VCU_MHU_info float32( fev_VCU_MHU_info.CRC_VCU_MHU_info*1+0 )
#define get_ALV_VCU_MHU_info float32( fev_VCU_MHU_info.ALV_VCU_MHU_info*1+0 )
#define get_VCU_CurPwrConsum float32( fev_VCU_MHU_info.VCU_CurPwrConsum*1+0 )
#define get_VCU_RemainingRange float32( fev_VCU_MHU_info.VCU_RemainingRange*0.5+0 )
#define get_VCU_ChgGun_Status float32( fev_VCU_MHU_info.VCU_ChgGun_Status*1+0 )
#define get_VCU_BattChargingStatus float32( fev_VCU_MHU_info.VCU_BattChargingStatus*1+0 )
#define get_VCU_VehChg_STS float32( fev_VCU_MHU_info.VCU_VehChg_STS*1+0 )
#define get_VCU_ChgGunConnStatus float32( fev_VCU_MHU_info.VCU_ChgGunConnStatus*1+0 )
#define get_VCU_BattSOC float32( fev_VCU_MHU_info.VCU_BattSOC*0.1+0 )
#define get_CRC_VCU_HVsystem_status float32( fev_VCU_HVsystem_status.CRC_VCU_HVsystem_status*1+0 )
#define get_ALIV_VCU_HVsystem_status float32( fev_VCU_HVsystem_status.ALIV_VCU_HVsystem_status*1+0 )
...
#define get_ALV_VCU_HV_DrvSys_bstatus float32( fev_VCU_HV_DrvSys_status.ALV_VCU_HV_DrvSys_bstatus*1+0 )
#define get_VCU_HV_SystemStatus float32( fev_VCU_HV_DrvSys_status.VCU_HV_SystemStatus*1+0 )
#define get_VCU_HV_DrvSystemStatus float32( fev_VCU_HV_DrvSys_status.VCU_HV_DrvSystemStatus*1+0 )
#define get_VCU_ACT_Gear float32( fev_VCU_HV_DrvSys_status.VCU_ACT_Gear*1+0 )
#define get_VCU_ACT_GearValid float32( fev_VCU_HV_DrvSys_status.VCU_ACT_GearValid*1+0 )
...
#define get_VCU_ACT_DriveMode float32( fev_VCU_HV_DrvSys_status.VCU_ACT_DriveMode*1+0 )
#define get_VCU_ACT_DriveModeValid float32( fev_VCU_HV_DrvSys_status.VCU_ACT_DriveModeValid*1+0 )
#define get_CRC_VCU_ChargingConnection float32( fev_VCU_ChargingConnection.CRC_VCU_ChargingConnection*1+0 )
...
#define get_CHSKM_VCU_Batt_WarnMsg float32( fev_VCU_Batt_WarnMsg.CHSKM_VCU_Batt_WarnMsg*1+0 )
#define get_ALV_VCU_Batt_WarnMsg float32( fev_VCU_Batt_WarnMsg.ALV_VCU_Batt_WarnMsg*1+0 )
#define get_BMS_PackTempSts float32( fev_VCU_Batt_WarnMsg.BMS_PackTempSts*1+0 )
#define get_BMS_ThermalRunaway float32( fev_VCU_Batt_WarnMsg.BMS_ThermalRunaway*1+0 )
#define get_BMS_CellTempErr float32( fev_VCU_Batt_WarnMsg.BMS_CellTempErr*1+0 )
#define get_BMS_HVILErr float32( fev_VCU_Batt_WarnMsg.BMS_HVILErr*1+0 )
#define get_BMS_PackInsuErr float32( fev_VCU_Batt_WarnMsg.BMS_PackInsuErr*1+0 )
#define get_BMS_MalfunctionSts float32( fev_VCU_Batt_WarnMsg.BMS_MalfunctionSts*1+0 )
#define get_BMS_LowBattery float32( fev_VCU_Batt_WarnMsg.BMS_LowBattery*1+0 )
#define get_BMS_FuseStatusErr float32( fev_VCU_Batt_WarnMsg.BMS_FuseStatusErr*1+0 )
#define get_BMS_CellVoltErr float32( fev_VCU_Batt_WarnMsg.BMS_CellVoltErr*1+0 )
#define get_BMS_PackVolErr float32( fev_VCU_Batt_WarnMsg.BMS_PackVolErr*1+0 )
#define get_BMS_PackOverCurrErr float32( fev_VCU_Batt_WarnMsg.BMS_PackOverCurrErr*1+0 )
#define get_BMS_Reserved_signal1 float32( fev_VCU_Batt_WarnMsg.BMS_Reserved_signal1*1+0 )
#define get_BMS_Reserved_signal2 float32( fev_VCU_Batt_WarnMsg.BMS_Reserved_signal2*1+0 )
#define get_BMS_Reserved_signal3 float32( fev_VCU_Batt_WarnMsg.BMS_Reserved_signal3*1+0 )
#define get_BMS_Reserved_signal4 float32( fev_VCU_Batt_WarnMsg.BMS_Reserved_signal4*1+0 )
#define get_BMS_Reserved_signal5 float32( fev_VCU_Batt_WarnMsg.BMS_Reserved_signal5*1+0 )
#define get_CRC_VCU_Batt_Info float32( fev_VCU_Batt_Info.CRC_VCU_Batt_Info*1+0 )
#define get_ALV_VCU_Batt_Info float32( fev_VCU_Batt_Info.ALV_VCU_Batt_Info*1+0 )
#define get_BMS_PackCur float32( fev_VCU_Batt_Info.BMS_PackCur*0.1+-1500 )
#define get_BMS_PackVoltage float32( fev_VCU_Batt_Info.BMS_PackVoltage*0.1+0 )
#define get_BMS_PackTemp float32( fev_VCU_Batt_Info.BMS_PackTemp*1+-40 )
#define get_BMS_RemainChargeTime float32( fev_VCU_Batt_Info.BMS_RemainChargeTime*1+0 )
#define get_BMS_ChargingVoltage float32( fev_VCU_Batt_Info.BMS_ChargingVoltage*0.1+0 )
#define get_BMS_ChargingCurrent float32( fev_VCU_Batt_Info.BMS_ChargingCurrent*0.1+0 )
...
#define get_StatusServiceDisconnectionPlug float32( fev_HighVoltageStorage200msNo1.StatusServiceDisconnectionPlug*1+0 )
#define get_StsDisconnectingSwtHighVoltStorg float32( fev_HighVoltageStorage200msNo1.StsDisconnectingSwtHighVoltStorg*1+0 )
#define get_CRC_HighVoltageStorage10msNo2 float32( fev_HighVoltageStorage10msNo2.CRC_HighVoltageStorage10msNo2*1+0 )
#define get_ALIV_HighVoltageStorage10msNo2 float32( fev_HighVoltageStorage10msNo2.ALIV_HighVoltageStorage10msNo2*1+0 )
#define get_ActualValueVoltageLinkVerified float32( fev_HighVoltageStorage10msNo2.ActualValueVoltageLinkVerified*0.25+0 )
...
#define get_CRC_DT_DISP_GRDT float32( fev_DT_DISP_GRDT.CRC_DT_DISP_GRDT*1+0 )
#define get_ALIV_DT_DISP_GRDT float32( fev_DT_DISP_GRDT.ALIV_DT_DISP_GRDT*1+0 )
#define get_DISP_PRG_GRB float32( fev_DT_DISP_GRDT.DISP_PRG_GRB*1+0 )
#define get_DISP_PO_IDC_GRB float32( fev_DT_DISP_GRDT.DISP_PO_IDC_GRB*1+0 )
#define get_DISP_PO_GRB float32( fev_DT_DISP_GRDT.DISP_PO_GRB*1+0 )
...
#define get_PowerETractSys2LimMotMax float32( fev_CombinedChargerUnit10msNo2.PowerETractSys2LimMotMax*50+-1638300 )
#define get_PowerETractSys1LimGenMax float32( fev_CombinedChargerUnit10msNo2.PowerETractSys1LimGenMax*50+-1638300 )
#define get_PowerETractSys2LimGenMax float32( fev_CombinedChargerUnit10msNo2.PowerETractSys2LimGenMax*50+-1638300 )
#define get_PowerETractSys1LimMotMax float32( fev_CombinedChargerUnit10msNo2.PowerETractSys1LimMotMax*50+-1638300 )
#define get_OperatingModeEANActualValue float32( fev_CombinedChargerUnit10msNo2.OperatingModeEANActualValue*1+0 )
#define get_RequestExtraBoostETractSys1 float32( fev_CombinedChargerUnit10msNo2.RequestExtraBoostETractSys1*1+0 )
#define get_RequestExtraBoostETractSys2 float32( fev_CombinedChargerUnit10msNo2.RequestExtraBoostETractSys2*1+0 )
...
#define get_OpModETractSys1ActVal float32( fev_TracEMacElectc1Time100msNo1.OpModETractSys1ActVal*1+0 )
#define get_OpModETractSys2ActVal float32( fev_TracEMacElectc2Time100msNo1.OpModETractSys2ActVal*1+0 )
