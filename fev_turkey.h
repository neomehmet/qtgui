...
#define get_CHKSM_ACChargingInfo() float32( FEV_VCU_ACCharging_Info.CHKSM_ACChargingInfo*1+ (0) )
#define get_ALIVE_ACChargingInfo() float32( FEV_VCU_ACCharging_Info.ALIVE_ACChargingInfo*1+ (0) )
...
#define get_CHKSM_DCChargingInfo() float32( FEV_VCU_DCCharging_Info.CHKSM_DCChargingInfo*1+ (0) )
#define get_ALIVE_DCChargingInfo() float32( FEV_VCU_DCCharging_Info.ALIVE_DCChargingInfo*1+ (0) )
...
#define get_Checksum_0x125() float32( FEV_BMS_AllowDischargeCurr.Checksum_0x125*1+ (0) )
#define get_Rolling_Counter_0x125() float32( FEV_BMS_AllowDischargeCurr.Rolling_Counter_0x125*1+ (0) )
#define get_BMS_AllowDischgCurr() float32( FEV_BMS_AllowDischargeCurr.BMS_AllowDischgCurr*0.1+ (0) )
#define get_BMS_AllowDischgCurrPeak() float32( FEV_BMS_AllowDischargeCurr.BMS_AllowDischgCurrPeak*0.1+ (0) )
#define get_SECCAN_BMS_AllowDischargeCurr() float32( FEV_BMS_AllowDischargeCurr.SECCAN_BMS_AllowDischargeCurr*1+ (0) )
#define get_Checksum_0x126() float32( FEV_BMS_AllowChargeCurr.Checksum_0x126*1+ (0) )
#define get_Rolling_Counter_0x126() float32( FEV_BMS_AllowChargeCurr.Rolling_Counter_0x126*1+ (0) )
#define get_BMS_AllowChgCurr() float32( FEV_BMS_AllowChargeCurr.BMS_AllowChgCurr*0.1+ (0) )
#define get_BMS_AllowChgCurrPeak() float32( FEV_BMS_AllowChargeCurr.BMS_AllowChgCurrPeak*0.1+ (0) )
#define get_SECCAN_BMS_AllowChargeCurr() float32( FEV_BMS_AllowChargeCurr.SECCAN_BMS_AllowChargeCurr*1+ (0) )
#define get_Checksum_0x127() float32( FEV_BMS_AllowDischgCurrAvg.Checksum_0x127*1+ (0) )
#define get_Rolling_Counter_0x127() float32( FEV_BMS_AllowDischgCurrAvg.Rolling_Counter_0x127*1+ (0) )
#define get_BMS_AllowDischgCurrAvg() float32( FEV_BMS_AllowDischgCurrAvg.BMS_AllowDischgCurrAvg*0.1+ (0) )
#define get_CHSKM_VCU_ChargingConnection() float32( FEV_VCU_ChargingConnection.CHSKM_VCU_ChargingConnection*1+ (0) )
#define get_ALV_VCU_ChargingConnection() float32( FEV_VCU_ChargingConnection.ALV_VCU_ChargingConnection*1+ (0) )
...
#define get_BMS_StartOfMeasument_STS() float32( FEV_BMS_CurMeas.BMS_StartOfMeasument_STS*1+ (0) )
...
#define get_Checksum_0x177() float32( FEV_BMS_HVMeas2.Checksum_0x177*1+ (0) )
#define get_Rolling_Counter_0x177() float32( FEV_BMS_HVMeas2.Rolling_Counter_0x177*1+ (0) )
#define get_BMS_HVBusVol_MEAS() float32( FEV_BMS_HVMeas2.BMS_HVBusVol_MEAS*0.1+ (0) )
#define get_BMS_HVFuseVol_MEAS() float32( FEV_BMS_HVMeas2.BMS_HVFuseVol_MEAS*0.1+ (0) )
#define get_CHSKM_VCU_Sts1() float32( FEV_VCU_Sts1.CHSKM_VCU_Sts1*1+ (0) )
#define get_ALV_VCU_Sts1() float32( FEV_VCU_Sts1.ALV_VCU_Sts1*1+ (0) )
#define get_VCU_BMS_HVOnOff_REQ() float32( FEV_VCU_Sts1.VCU_BMS_HVOnOff_REQ*1+ (0) )
...
#define get_Checksum_0x205() float32( FEV_BMS_VolMeas1.Checksum_0x205*1+ (0) )
#define get_Rolling_Counter_0x205() float32( FEV_BMS_VolMeas1.Rolling_Counter_0x205*1+ (0) )
#define get_BMS_CellNumMinCellVol() float32( FEV_BMS_VolMeas1.BMS_CellNumMinCellVol*1+ (0) )
#define get_BMS_CellNumMaxCellVol() float32( FEV_BMS_VolMeas1.BMS_CellNumMaxCellVol*1+ (0) )
#define get_BMS_MinCellVol() float32( FEV_BMS_VolMeas1.BMS_MinCellVol*0.001+ (0) )
#define get_BMS_MaxCellVol() float32( FEV_BMS_VolMeas1.BMS_MaxCellVol*0.001+ (0) )
#define get_Checksum_0x206() float32( FEV_BMS_VolMeas2.Checksum_0x206*1+ (0) )
#define get_Rolling_Counter_0x206() float32( FEV_BMS_VolMeas2.Rolling_Counter_0x206*1+ (0) )
#define get_BMS_MaxMinDiffCellVol() float32( FEV_BMS_VolMeas2.BMS_MaxMinDiffCellVol*0.001+ (0) )
#define get_SECCAN_BMS_VolMeas2() float32( FEV_BMS_VolMeas2.SECCAN_BMS_VolMeas2*1+ (0) )
#define get_Checksum_0x209() float32( FEV_BMS_PowerCont.Checksum_0x209*1+ (0) )
#define get_Rolling_Counter_0x209() float32( FEV_BMS_PowerCont.Rolling_Counter_0x209*1+ (0) )
#define get_BMS_MaxDischgPwr_ALW() float32( FEV_BMS_PowerCont.BMS_MaxDischgPwr_ALW*0.1+ (0) )
#define get_BMS_MaxChgPwr_ALW() float32( FEV_BMS_PowerCont.BMS_MaxChgPwr_ALW*0.1+ (0) )
#define get_BMS_MaxDischgPwr_Peak() float32( FEV_BMS_PowerCont.BMS_MaxDischgPwr_Peak*0.2+ (0) )
#define get_BMS_MaxChgPwr_Peak() float32( FEV_BMS_PowerCont.BMS_MaxChgPwr_Peak*0.2+ (0) )
...
#define get_Checksum_0x213() float32( FEV_BMS_PowerAvg.Checksum_0x213*1+ (0) )
#define get_Rolling_Counter_0x213() float32( FEV_BMS_PowerAvg.Rolling_Counter_0x213*1+ (0) )
#define get_BMS_AvgDischgPwr_ALW() float32( FEV_BMS_PowerAvg.BMS_AvgDischgPwr_ALW*0.1+ (0) )
#define get_Checksum_0x214() float32( FEV_BMS_Sts_0x214.Checksum_0x214*1+ (0) )
#define get_Rolling_Counter_0x214() float32( FEV_BMS_Sts_0x214.Rolling_Counter_0x214*1+ (0) )
#define get_BMS_Display_SOC() float32( FEV_BMS_Sts_0x214.BMS_Display_SOC*0.1+ (0) )
#define get_BMS_MinCellSOC() float32( FEV_BMS_Sts_0x214.BMS_MinCellSOC*0.1+ (0) )
#define get_BMS_MaxCellSOC() float32( FEV_BMS_Sts_0x214.BMS_MaxCellSOC*0.1+ (0) )
#define get_BMS_ProbeNumMaxCellSOC() float32( FEV_BMS_Sts_0x214.BMS_ProbeNumMaxCellSOC*1+ (0) )
#define get_BMS_ProbeNumMinCellSOC() float32( FEV_BMS_Sts_0x214.BMS_ProbeNumMinCellSOC*1+ (0) )
...
#define get_BMS_HV_Sts() float32( FEV_BMS_Sts.BMS_HV_Sts*1+ (0) )
#define get_Checksum_0x216() float32( FEV_BMS_ChgParamReq.Checksum_0x216*1+ (0) )
#define get_Rolling_Counter_0x216() float32( FEV_BMS_ChgParamReq.Rolling_Counter_0x216*1+ (0) )
#define get_BMS_RemainChargeTime() float32( FEV_BMS_ChgParamReq.BMS_RemainChargeTime*1+ (0) )
#define get_BMS_ChgVoltage_REQ() float32( FEV_BMS_ChgParamReq.BMS_ChgVoltage_REQ*0.1+ (0) )
#define get_BMS_ChgCurrent_REQ() float32( FEV_BMS_ChgParamReq.BMS_ChgCurrent_REQ*0.1+ (0) )
#define get_CHSKM_VCU_BMS_Information() float32( FEV_VCU_BMS_Information.CHSKM_VCU_BMS_Information*1+ (0) )
#define get_ALIV_VCU_BMS_Information() float32( FEV_VCU_BMS_Information.ALIV_VCU_BMS_Information*1+ (0) )
#define get_VCU_DCChargeRelayP() float32( FEV_VCU_BMS_Information.VCU_DCChargeRelayP*1+ (0) )
#define get_VCU_DCChargeRelayN() float32( FEV_VCU_BMS_Information.VCU_DCChargeRelayN*1+ (0) )
#define get_VCU_BMS_Insulation_Mon_Req() float32( FEV_VCU_BMS_Information.VCU_BMS_Insulation_Mon_Req*1+ (0) )
#define get_CHSKM_VCU_PTControl() float32( FEV_VCU_PTControl.CHSKM_VCU_PTControl*1+ (0) )
#define get_ALV_VCU_PTControl() float32( FEV_VCU_PTControl.ALV_VCU_PTControl*1+ (0) )
#define get_VCU_ChargeAllow() float32( FEV_VCU_PTControl.VCU_ChargeAllow*1+ (0) )
#define get_CHSKM_VCU_BMS_Thermal_FB() float32( FEV_VCU_BMS_Thermal_FB.CHSKM_VCU_BMS_Thermal_FB*1+ (0) )
#define get_ALIV_VCU_BMS_Thermal_FB() float32( FEV_VCU_BMS_Thermal_FB.ALIV_VCU_BMS_Thermal_FB*1+ (0) )
#define get_VCU_BMS_PTCOnOff_Sts() float32( FEV_VCU_BMS_Thermal_FB.VCU_BMS_PTCOnOff_Sts*1+ (0) )
#define get_VCU_BMS_ValveOnOff_Sts() float32( FEV_VCU_BMS_Thermal_FB.VCU_BMS_ValveOnOff_Sts*1+ (0) )
#define get_VCU_BMS_PumpFB() float32( FEV_VCU_BMS_Thermal_FB.VCU_BMS_PumpFB*1+ (0) )
#define get_Checksum_0x225() float32( FEV_BMS_FaultMgr_0x225.Checksum_0x225*1+ (0) )
#define get_Rolling_Counter_0x225() float32( FEV_BMS_FaultMgr_0x225.Rolling_Counter_0x225*1+ (0) )
#define get_CDM_bAcvCanComStblMon() float32( FEV_BMS_FaultMgr_0x225.CDM_bAcvCanComStblMon*1+ (0) )
#define get_FRMo_bErrHvbatStReqExtMon() float32( FEV_BMS_FaultMgr_0x225.FRMo_bErrHvbatStReqExtMon*1+ (0) )
#define get_FRMo_bErrChrgnAllwdExtMon() float32( FEV_BMS_FaultMgr_0x225.FRMo_bErrChrgnAllwdExtMon*1+ (0) )
#define get_FRMo_bErrVehCrashStExtMon() float32( FEV_BMS_FaultMgr_0x225.FRMo_bErrVehCrashStExtMon*1+ (0) )
#define get_CDM_bErrComctnLossCanMon() float32( FEV_BMS_FaultMgr_0x225.CDM_bErrComctnLossCanMon*1+ (0) )
#define get_CTCMon_bErrCtctrSopcMon() float32( FEV_BMS_FaultMgr_0x225.CTCMon_bErrCtctrSopcMon*1+ (0) )
#define get_CTCMon_bInvldCtctrHisdIFbMon() float32( FEV_BMS_FaultMgr_0x225.CTCMon_bInvldCtctrHisdIFbMon*1+ (0) )
#define get_CTCMon_bInvldCtctrLosdUFbMon() float32( FEV_BMS_FaultMgr_0x225.CTCMon_bInvldCtctrLosdUFbMon*1+ (0) )
#define get_CTM_bErrCellTDifMaxMon() float32( FEV_BMS_FaultMgr_0x225.CTM_bErrCellTDifMaxMon*1+ (0) )
#define get_CTM_bErrCellTMaxMon() float32( FEV_BMS_FaultMgr_0x225.CTM_bErrCellTMaxMon*1+ (0) )
#define get_CTM_bErrCellTMinMon() float32( FEV_BMS_FaultMgr_0x225.CTM_bErrCellTMinMon*1+ (0) )
#define get_CTM_bErrThrwyPredMon() float32( FEV_BMS_FaultMgr_0x225.CTM_bErrThrwyPredMon*1+ (0) )
#define get_CUM_bErrCellUDifMaxMon() float32( FEV_BMS_FaultMgr_0x225.CUM_bErrCellUDifMaxMon*1+ (0) )
#define get_CUM_bErrCellUMaxMon() float32( FEV_BMS_FaultMgr_0x225.CUM_bErrCellUMaxMon*1+ (0) )
#define get_CUM_bErrCellUMinMon() float32( FEV_BMS_FaultMgr_0x225.CUM_bErrCellUMinMon*1+ (0) )
#define get_CUM_bErrCellUProtnMaxNvMon() float32( FEV_BMS_FaultMgr_0x225.CUM_bErrCellUProtnMaxNvMon*1+ (0) )
#define get_CUM_bErrCellUProtnMinNvMon() float32( FEV_BMS_FaultMgr_0x225.CUM_bErrCellUProtnMinNvMon*1+ (0) )
#define get_CUM_bErrPackUImplyMon() float32( FEV_BMS_FaultMgr_0x225.CUM_bErrPackUImplyMon*1+ (0) )
#define get_EHPMon_bRdyHvilMon() float32( FEV_BMS_FaultMgr_0x225.EHPMon_bRdyHvilMon*1+ (0) )
#define get_EHPMon_bErrWlddNegNvMon() float32( FEV_BMS_FaultMgr_0x225.EHPMon_bErrWlddNegNvMon*1+ (0) )
#define get_EHPMon_bErrWlddPosNvMon() float32( FEV_BMS_FaultMgr_0x225.EHPMon_bErrWlddPosNvMon*1+ (0) )
#define get_EHPMon_bErrWlddPrechNvMon() float32( FEV_BMS_FaultMgr_0x225.EHPMon_bErrWlddPrechNvMon*1+ (0) )
#define get_EHPMon_bErrHvilMon() float32( FEV_BMS_FaultMgr_0x225.EHPMon_bErrHvilMon*1+ (0) )
#define get_EHPMon_bErrHvilShoMon() float32( FEV_BMS_FaultMgr_0x225.EHPMon_bErrHvilShoMon*1+ (0) )
#define get_EHPMon_bErrPackIslnRNvMon() float32( FEV_BMS_FaultMgr_0x225.EHPMon_bErrPackIslnRNvMon*1+ (0) )
#define get_EHPMon_bErrVehCrashNvMon() float32( FEV_BMS_FaultMgr_0x225.EHPMon_bErrVehCrashNvMon*1+ (0) )
#define get_EHPMon_bErrVehIslnRNvMon() float32( FEV_BMS_FaultMgr_0x225.EHPMon_bErrVehIslnRNvMon*1+ (0) )
#define get_FRMo_bErrMemStorgNvMon() float32( FEV_BMS_FaultMgr_0x225.FRMo_bErrMemStorgNvMon*1+ (0) )
#define get_L1IM_bErrClmp30MaxMonInp() float32( FEV_BMS_FaultMgr_0x225.L1IM_bErrClmp30MaxMonInp*1+ (0) )
#define get_L1IM_bErrClmp30MinMonInp() float32( FEV_BMS_FaultMgr_0x225.L1IM_bErrClmp30MinMonInp*1+ (0) )
#define get_L1IM_bErrCtctrDtrtMonInp() float32( FEV_BMS_FaultMgr_0x225.L1IM_bErrCtctrDtrtMonInp*1+ (0) )
#define get_L1IM_bErrUActImplyMonInp() float32( FEV_BMS_FaultMgr_0x225.L1IM_bErrUActImplyMonInp*1+ (0) )
#define get_MCCM_bAcvMdulCtlrStsMon() float32( FEV_BMS_FaultMgr_0x225.MCCM_bAcvMdulCtlrStsMon*1+ (0) )
#define get_MCCM_bErrLntecSngFltMon() float32( FEV_BMS_FaultMgr_0x225.MCCM_bErrLntecSngFltMon*1+ (0) )
#define get_MCCM_bErrLntecLtntFltMon() float32( FEV_BMS_FaultMgr_0x225.MCCM_bErrLntecLtntFltMon*1+ (0) )
#define get_MCCM_bErrMdulCellSnsrCfgMon() float32( FEV_BMS_FaultMgr_0x225.MCCM_bErrMdulCellSnsrCfgMon*1+ (0) )
#define get_MCCM_bErrMdulCtlrComMon() float32( FEV_BMS_FaultMgr_0x225.MCCM_bErrMdulCtlrComMon*1+ (0) )
#define get_MCCM_bErrSnsrTEltlMon() float32( FEV_BMS_FaultMgr_0x225.MCCM_bErrSnsrTEltlMon*1+ (0) )
#define get_MCCM_bWarnSnsrTEltlMon() float32( FEV_BMS_FaultMgr_0x225.MCCM_bWarnSnsrTEltlMon*1+ (0) )
#define get_PCM_bRdySnsrIMon() float32( FEV_BMS_FaultMgr_0x225.PCM_bRdySnsrIMon*1+ (0) )
#define get_PCM_bErrPackEFlowMaxLimMon() float32( FEV_BMS_FaultMgr_0x225.PCM_bErrPackEFlowMaxLimMon*1+ (0) )
#define get_PCM_bErrPackIChDchaMaxLimMon() float32( FEV_BMS_FaultMgr_0x225.PCM_bErrPackIChDchaMaxLimMon*1+ (0) )
#define get_PCM_bErrSnsrIImplyMon() float32( FEV_BMS_FaultMgr_0x225.PCM_bErrSnsrIImplyMon*1+ (0) )
#define get_FRMo_bErrSnsrI1ExtMon() float32( FEV_BMS_FaultMgr_0x225.FRMo_bErrSnsrI1ExtMon*1+ (0) )
#define get_PCM_bInvldSnsrI1Mon() float32( FEV_BMS_FaultMgr_0x225.PCM_bInvldSnsrI1Mon*1+ (0) )
#define get_PCM_bInvldSnsrI2Mon() float32( FEV_BMS_FaultMgr_0x225.PCM_bInvldSnsrI2Mon*1+ (0) )
#define get_FRMo_bErrSopcLvl3Mon() float32( FEV_BMS_FaultMgr_0x225.FRMo_bErrSopcLvl3Mon*1+ (0) )
#define get_BMS_FRMo_Reserved_1() float32( FEV_BMS_FaultMgr_0x225.BMS_FRMo_Reserved_1*1+ (0) )
#define get_BMS_FRMo_Reserved_2() float32( FEV_BMS_FaultMgr_0x225.BMS_FRMo_Reserved_2*1+ (0) )
#define get_BMS_FRMo_Reserved_3() float32( FEV_BMS_FaultMgr_0x225.BMS_FRMo_Reserved_3*1+ (0) )
#define get_BMS_FRMo_Reserved_4() float32( FEV_BMS_FaultMgr_0x225.BMS_FRMo_Reserved_4*1+ (0) )
#define get_BMS_FRMo_Reserved_5() float32( FEV_BMS_FaultMgr_0x225.BMS_FRMo_Reserved_5*1+ (0) )
#define get_Checksum_0x226() float32( FEV_BMS_QMMgr_0x226.Checksum_0x226*1+ (0) )
#define get_Rolling_Counter_0x226() float32( FEV_BMS_QMMgr_0x226.Rolling_Counter_0x226*1+ (0) )
#define get_BMS_QMMo_Reserved_0() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_0*1+ (0) )
#define get_BMS_QMMo_Reserved_1() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_1*1+ (0) )
#define get_BMS_QMMo_Reserved_2() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_2*1+ (0) )
#define get_BMS_QMMo_Reserved_3() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_3*1+ (0) )
#define get_BMS_QMMo_Reserved_4() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_4*1+ (0) )
#define get_BMS_QMMo_Reserved_5() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_5*1+ (0) )
#define get_BMS_QMMo_Reserved_6() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_6*1+ (0) )
#define get_BMS_QMMo_Reserved_7() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_7*1+ (0) )
#define get_BMS_QMMo_Reserved_8() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_8*1+ (0) )
#define get_BMS_QMMo_Reserved_9() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_9*1+ (0) )
#define get_BMS_QMMo_Reserved_10() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_10*1+ (0) )
#define get_BMS_QMMo_Reserved_11() float32( FEV_BMS_QMMgr_0x226.BMS_QMMo_Reserved_11*1+ (0) )
#define get_CDEM_ErrDisp_0() float32( FEV_BMS_QMMgr_0x226.CDEM_ErrDisp_0*1+ (0) )
#define get_CDEM_ErrDisp_1() float32( FEV_BMS_QMMgr_0x226.CDEM_ErrDisp_1*1+ (0) )
#define get_BMS_Capacity_Thrput_Charge() float32( FEV_BMS_CapacityThrput.BMS_Capacity_Thrput_Charge*1+ (0) )
#define get_BMS_Capacity_Thrput_Discharge() float32( FEV_BMS_CapacityThrput.BMS_Capacity_Thrput_Discharge*1+ (0) )
#define get_Checksum_0x245() float32( FEV_BMS_CellTemp.Checksum_0x245*1+ (0) )
#define get_Rolling_Counter_0x245() float32( FEV_BMS_CellTemp.Rolling_Counter_0x245*1+ (0) )
#define get_BMS_ProbeNumMaxCellTemp() float32( FEV_BMS_CellTemp.BMS_ProbeNumMaxCellTemp*1+ (0) )
#define get_BMS_MinCellTemp() float32( FEV_BMS_CellTemp.BMS_MinCellTemp*1+ (-40) )
#define get_BMS_ProbeNumMinCellTemp() float32( FEV_BMS_CellTemp.BMS_ProbeNumMinCellTemp*1+ (0) )
...
#define get_Checksum_0x246() float32( FEV_BMS_CellAverage.Checksum_0x246*1+ (0) )
#define get_Rolling_Counter_0x246() float32( FEV_BMS_CellAverage.Rolling_Counter_0x246*1+ (0) )
#define get_BMS_CellTemp_Avg() float32( FEV_BMS_CellAverage.BMS_CellTemp_Avg*1+ (40) )
#define get_BMS_CellTemp_StdDev() float32( FEV_BMS_CellAverage.BMS_CellTemp_StdDev*1+ (40) )
#define get_BMS_CellVol_Avg() float32( FEV_BMS_CellAverage.BMS_CellVol_Avg*0.001+ (0) )
#define get_BMS_CellVol_StdDev() float32( FEV_BMS_CellAverage.BMS_CellVol_StdDev*0.001+ (0) )
#define get_CHSKM_BMS_VCU_THMReq() float32( FEV_BMS_VCU_THMReq.CHSKM_BMS_VCU_THMReq*1+ (0) )
#define get_ALV_BMS_VCU_THMReq() float32( FEV_BMS_VCU_THMReq.ALV_BMS_VCU_THMReq*1+ (0) )
#define get_BMS_FlowRate_Req() float32( FEV_BMS_VCU_THMReq.BMS_FlowRate_Req*1+ (0) )
#define get_BMS_CoolPwrDemand() float32( FEV_BMS_VCU_THMReq.BMS_CoolPwrDemand*0.1+ (0) )
#define get_BMS_HeatPwrDemand() float32( FEV_BMS_VCU_THMReq.BMS_HeatPwrDemand*0.1+ (0) )
#define get_BMS_VCU_PTCOnOff_Req() float32( FEV_BMS_VCU_THMReq.BMS_VCU_PTCOnOff_Req*1+ (0) )
#define get_BMS_VCU_ValveOnOff_Req() float32( FEV_BMS_VCU_THMReq.BMS_VCU_ValveOnOff_Req*1+ (0) )
...
#define get_BMS_BDUTemp1() float32( FEV_BMS_CoolntInletOutletTmp.BMS_BDUTemp1*1+ (-40) )
#define get_BMS_BDUTemp2() float32( FEV_BMS_CoolntInletOutletTmp.BMS_BDUTemp2*1+ (-40) )
...
#define get_TEMP_EX() float32( FEV_IC_TEMP.TEMP_EX*0.5+ (-40) )
#define get_TEMP_EX_UNFILT() float32( FEV_IC_TEMP.TEMP_EX_UNFILT*0.5+ (-40) )
...
#define get_CHSKM_BMS_Insulation() float32( FEV_BMS_Insulation.CHSKM_BMS_Insulation*1+ (0) )
#define get_ALV_BMS_Insulation() float32( FEV_BMS_Insulation.ALV_BMS_Insulation*1+ (0) )
#define get_BMS_VCU_Insulation_Mon_Sts() float32( FEV_BMS_Insulation.BMS_VCU_Insulation_Mon_Sts*1+ (0) )
#define get_BMS_PackInsuRes() float32( FEV_BMS_Insulation.BMS_PackInsuRes*1+ (0) )
#define get_Checksum_0x307() float32( FEV_BMS_Sensor_Start_Stop_0x307.Checksum_0x307*1+ (0) )
#define get_Rolling_Counter_0x307() float32( FEV_BMS_Sensor_Start_Stop_0x307.Rolling_Counter_0x307*1+ (0) )
#define get_BMS_Start_Stop_DM13() float32( FEV_BMS_Sensor_Start_Stop_0x307.BMS_Start_Stop_DM13*1+ (0) )
#define get_Checksum_0x308() float32( FEV_BMS_Sensor_Output02_0x308.Checksum_0x308*1+ (0) )
#define get_Rolling_Counter_0x308() float32( FEV_BMS_Sensor_Output02_0x308.Rolling_Counter_0x308*1+ (0) )
#define get_BMS_SensorSts_H2() float32( FEV_BMS_Sensor_Output02_0x308.BMS_SensorSts_H2*1+ (0) )
#define get_BMS_SensorSts_Temperature() float32( FEV_BMS_Sensor_Output02_0x308.BMS_SensorSts_Temperature*1+ (0) )
#define get_BMS_H2() float32( FEV_BMS_Sensor_Output02_0x308.BMS_H2*0.0025+ (0) )
#define get_BMS__Temperature() float32( FEV_BMS_Sensor_Output02_0x308.BMS__Temperature*0.03125+ (-273) )
#define get_Checksum_0x309() float32( FEV_BMS_Sensor_Output01_0x309.Checksum_0x309*1+ (0) )
#define get_Rolling_Counter_0x309() float32( FEV_BMS_Sensor_Output01_0x309.Rolling_Counter_0x309*1+ (0) )
#define get_BMS_SensorSts_Humidity() float32( FEV_BMS_Sensor_Output01_0x309.BMS_SensorSts_Humidity*1+ (0) )
#define get_BMS_SensorSts_Pressure() float32( FEV_BMS_Sensor_Output01_0x309.BMS_SensorSts_Pressure*1+ (0) )
#define get_BMS_Humidity() float32( FEV_BMS_Sensor_Output01_0x309.BMS_Humidity*0.4+ (0) )
#define get_BMS_Pressure() float32( FEV_BMS_Sensor_Output01_0x309.BMS_Pressure*0.0078125+ (-250) )
#define get_BMS_SensorSts_Voltage_Level() float32( FEV_BMS_Sensor_Output01_0x309.BMS_SensorSts_Voltage_Level*1+ (0) )
#define get_BMS_SensorSts_Reserved() float32( FEV_BMS_Sensor_Output01_0x309.BMS_SensorSts_Reserved*1+ (0) )
#define get_BMS_SensorSts_Internal_Temp() float32( FEV_BMS_Sensor_Output01_0x309.BMS_SensorSts_Internal_Temp*1+ (0) )
#define get_BMS_SensorSts_Brown_Out_Recovery() float32( FEV_BMS_Sensor_Output01_0x309.BMS_SensorSts_Brown_Out_Recovery*1+ (0) )
#define get_Checksum_0x315() float32( FEV_BMS_Sensor_Config_0x315.Checksum_0x315*1+ (0) )
#define get_BMS_Config_Number_Of_byte() float32( FEV_BMS_Sensor_Config_0x315.BMS_Config_Number_Of_byte*1+ (0) )
#define get_BMS_Config_Read_Write() float32( FEV_BMS_Sensor_Config_0x315.BMS_Config_Read_Write*1+ (0) )
#define get_BMS_Config_Address() float32( FEV_BMS_Sensor_Config_0x315.BMS_Config_Address*1+ (0) )
#define get_BMS_Config_Data() float32( FEV_BMS_Sensor_Config_0x315.BMS_Config_Data*1+ (0) )
#define get_Checksum_0x316() float32( FEV_BMS_Sensor_Read_Config_0x316.Checksum_0x316*1+ (0) )
#define get_BMS_Read_Config_Number_Of_byte() float32( FEV_BMS_Sensor_Read_Config_0x316.BMS_Read_Config_Number_Of_byte*1+ (0) )
#define get_BMS_Read_Config_Address() float32( FEV_BMS_Sensor_Read_Config_0x316.BMS_Read_Config_Address*1+ (0) )
#define get_BMS_Read_Config_Data() float32( FEV_BMS_Sensor_Read_Config_0x316.BMS_Read_Config_Data*1+ (0) )
#define get_Checksum_0x330() float32( FEV_BMS_HistData.Checksum_0x330*1+ (0) )
#define get_Rolling_Counter_0x330() float32( FEV_BMS_HistData.Rolling_Counter_0x330*1+ (0) )
#define get_BMS_ContactorAging() float32( FEV_BMS_HistData.BMS_ContactorAging*1+ (0) )
#define get_Checksum_0x332() float32( FEV_BMS_PackInfo.Checksum_0x332*1+ (0) )
#define get_Rolling_Counter_0x332() float32( FEV_BMS_PackInfo.Rolling_Counter_0x332*1+ (0) )
#define get_BMS_PackCNom() float32( FEV_BMS_PackInfo.BMS_PackCNom*0.1+ (0) )
#define get_BMS_PackTemp_0x332() float32( FEV_BMS_PackInfo.BMS_PackTemp_0x332*1+ (-40) )
#define get_BMS_SOHc() float32( FEV_BMS_PackInfo.BMS_SOHc*1+ (0) )
#define get_BMS_SOHr() float32( FEV_BMS_PackInfo.BMS_SOHr*1+ (0) )
#define get_SECCAN_BMS_PackInfo() float32( FEV_BMS_PackInfo.SECCAN_BMS_PackInfo*1+ (0) )
...
#define get_CRC_VCU_HMI_Info() float32( FEV_VCU_HMI_Info.CRC_VCU_HMI_Info*1+ (0) )
#define get_ALIV_VCU_HMI_Info() float32( FEV_VCU_HMI_Info.ALIV_VCU_HMI_Info*1+ (0) )
...
#define get_Checksum_0x455() float32( FEV_BMS_ERROR.Checksum_0x455*1+ (0) )
#define get_Rolling_Counter_0x455() float32( FEV_BMS_ERROR.Rolling_Counter_0x455*1+ (0) )
#define get_BMS_CellLowVol_ERR() float32( FEV_BMS_ERROR.BMS_CellLowVol_ERR*1+ (0) )
#define get_BMS_HVIL_Err() float32( FEV_BMS_ERROR.BMS_HVIL_Err*1+ (0) )
#define get_BMS_PackInsu_ERR() float32( FEV_BMS_ERROR.BMS_PackInsu_ERR*1+ (0) )
#define get_BMS_CellVoltDiff_ERR() float32( FEV_BMS_ERROR.BMS_CellVoltDiff_ERR*1+ (0) )
#define get_BMS_ProbeTempDiff_ERR() float32( FEV_BMS_ERROR.BMS_ProbeTempDiff_ERR*1+ (0) )
#define get_BMS_PackHighVol_ERR() float32( FEV_BMS_ERROR.BMS_PackHighVol_ERR*1+ (0) )
#define get_BMS_PackLowVol_ERR() float32( FEV_BMS_ERROR.BMS_PackLowVol_ERR*1+ (0) )
#define get_BMS_CellHighVol_ERR() float32( FEV_BMS_ERROR.BMS_CellHighVol_ERR*1+ (0) )
#define get_BMS_ProbeHighTemp_ERR() float32( FEV_BMS_ERROR.BMS_ProbeHighTemp_ERR*1+ (0) )
#define get_BMS_FuseStatus_ERR() float32( FEV_BMS_ERROR.BMS_FuseStatus_ERR*1+ (0) )
#define get_BMS_PackOverCurr_ERR() float32( FEV_BMS_ERROR.BMS_PackOverCurr_ERR*1+ (0) )
#define get_BMS_ProbeLowTemp_ERR() float32( FEV_BMS_ERROR.BMS_ProbeLowTemp_ERR*1+ (0) )
#define get_CHSKM_BMS_WarnMsg() float32( FEV_BMS_WarnMsg.CHSKM_BMS_WarnMsg*1+ (0) )
#define get_ALV_BMS_WarnMsg() float32( FEV_BMS_WarnMsg.ALV_BMS_WarnMsg*1+ (0) )
#define get_BMS_PackTempSts() float32( FEV_BMS_WarnMsg.BMS_PackTempSts*1+ (0) )
#define get_BMS_ThermalRunaway() float32( FEV_BMS_WarnMsg.BMS_ThermalRunaway*1+ (0) )
#define get_BMS_BatteryReplacement() float32( FEV_BMS_WarnMsg.BMS_BatteryReplacement*1+ (0) )
#define get_BMS_Warning_PowerDegrade() float32( FEV_BMS_WarnMsg.BMS_Warning_PowerDegrade*1+ (0) )
#define get_BMS_Warning_DeltaSoC() float32( FEV_BMS_WarnMsg.BMS_Warning_DeltaSoC*1+ (0) )
#define get_BMS_Warning_HVILSts() float32( FEV_BMS_WarnMsg.BMS_Warning_HVILSts*1+ (0) )
#define get_BMS_Warning_Isolation() float32( FEV_BMS_WarnMsg.BMS_Warning_Isolation*1+ (0) )
#define get_BMS_Warning_CoolantLeakage() float32( FEV_BMS_WarnMsg.BMS_Warning_CoolantLeakage*1+ (0) )
#define get_BMS_MalfunctionSts() float32( FEV_BMS_WarnMsg.BMS_MalfunctionSts*1+ (0) )
#define get_BMS_LowBattery() float32( FEV_BMS_WarnMsg.BMS_LowBattery*1+ (0) )
#define get_BMS_Warning_DeltaTemperature() float32( FEV_BMS_WarnMsg.BMS_Warning_DeltaTemperature*1+ (0) )
#define get_BMS_Warning_BDUTemperatureSts() float32( FEV_BMS_WarnMsg.BMS_Warning_BDUTemperatureSts*1+ (0) )
#define get_BMS_Reserved_signal3() float32( FEV_BMS_WarnMsg.BMS_Reserved_signal3*1+ (0) )
#define get_BMS_Reserved_signal4() float32( FEV_BMS_WarnMsg.BMS_Reserved_signal4*1+ (0) )
#define get_BMS_Reserved_signal5() float32( FEV_BMS_WarnMsg.BMS_Reserved_signal5*1+ (0) )
...
#define get_BMS_srcNodeID() float32( FEV_BMS_NM.BMS_srcNodeID*1+ (0) )
#define get_BMS_CtrlBitVector() float32( FEV_BMS_NM.BMS_CtrlBitVector*1+ (0) )
#define get_BMS_usrData0() float32( FEV_BMS_NM.BMS_usrData0*1+ (0) )
#define get_BMS_usrData1() float32( FEV_BMS_NM.BMS_usrData1*1+ (0) )
#define get_BMS_usrData2() float32( FEV_BMS_NM.BMS_usrData2*1+ (0) )
#define get_BMS_usrData3() float32( FEV_BMS_NM.BMS_usrData3*1+ (0) )
#define get_BMS_usrData4() float32( FEV_BMS_NM.BMS_usrData4*1+ (0) )
#define get_BMS_usrData5() float32( FEV_BMS_NM.BMS_usrData5*1+ (0) )
#define get_BMS_DiagRespData0() float32( FEV_BMS_DiagResp.BMS_DiagRespData0*1+ (0) )
#define get_BMS_DiagRespData1() float32( FEV_BMS_DiagResp.BMS_DiagRespData1*1+ (0) )
#define get_BMS_DiagRespData2() float32( FEV_BMS_DiagResp.BMS_DiagRespData2*1+ (0) )
#define get_BMS_DiagRespData3() float32( FEV_BMS_DiagResp.BMS_DiagRespData3*1+ (0) )
#define get_BMS_DiagRespData4() float32( FEV_BMS_DiagResp.BMS_DiagRespData4*1+ (0) )
#define get_BMS_DiagRespData5() float32( FEV_BMS_DiagResp.BMS_DiagRespData5*1+ (0) )
#define get_BMS_DiagRespData6() float32( FEV_BMS_DiagResp.BMS_DiagRespData6*1+ (0) )
#define get_BMS_DiagRespData7() float32( FEV_BMS_DiagResp.BMS_DiagRespData7*1+ (0) )
#define get_BMS_DiagReqData0() float32( FEV_BMS_DiagReq.BMS_DiagReqData0*1+ (0) )
#define get_BMS_DiagReqData1() float32( FEV_BMS_DiagReq.BMS_DiagReqData1*1+ (0) )
#define get_BMS_DiagReqData2() float32( FEV_BMS_DiagReq.BMS_DiagReqData2*1+ (0) )
#define get_BMS_DiagReqData3() float32( FEV_BMS_DiagReq.BMS_DiagReqData3*1+ (0) )
#define get_BMS_DiagReqData4() float32( FEV_BMS_DiagReq.BMS_DiagReqData4*1+ (0) )
#define get_BMS_DiagReqData5() float32( FEV_BMS_DiagReq.BMS_DiagReqData5*1+ (0) )
#define get_BMS_DiagReqData6() float32( FEV_BMS_DiagReq.BMS_DiagReqData6*1+ (0) )
#define get_BMS_DiagReqData7() float32( FEV_BMS_DiagReq.BMS_DiagReqData7*1+ (0) )
...
#define get_SEED_CAN_Req12() float32( FEV_SEED_CAN_Req12_VCU_BA.SEED_CAN_Req12*1+ (0) )
#define get_SEED_CAN_Req24() float32( FEV_SEED_CAN_Req24_BMS.SEED_CAN_Req24*1+ (0) )
#define get_BMS_XCPTxData() float32( FEV_BMS_XCPTx.BMS_XCPTxData*1+ (0) )
#define get_BMS_XCPRxData() float32( FEV_BMS_XCPRx.BMS_XCPRxData*1+ (0) )
